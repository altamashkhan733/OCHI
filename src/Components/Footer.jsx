    ...
    <div className='w-full h-screen bg-zinc-900 flex gap-5 p-20 '>
      <div className='w-1/2 h-full flex flex-col justify-between'>
        <div className='headings'>
           <h1 className='text-[8vw] font-semibold uppercase leading-none tracking-tighter -mb-8'>Eye-</h1>
           <h1 className='text-[8vw] font-semibold uppercase leading-none tracking-tighter -mb-8'>Opening</h1> 
        </div>
      ...
      <div className='w-1/2 '>
        <h1 className='text-[6vw] font-semibold uppercase leading-none tracking-tighter -mb-8'>Presentation
        </h1>
        <div className='details mt-10'>
        <a className=' mb-10 block text-xl font-light' href="#">S:</a>    
        <a className='underline block text-xl font-light' href="#">Instagram</a>
        <a className='underline block text-xl font-light' href="#">Behance</a>
        <a className='underline block text-xl font-light' href="#">Facebook</a>
        <a className='underline block text-xl font-light' href="#">Linkedin</a>
        </div>

        <div className='details mt-10 '>
        <a className=' mb-10 block text-xl font-light' href="#">L:</a>    
        <a className='underline block text-xl font-light' href="#">202-1965 W 4th Ave</a>
        <a className='underline block text-xl font-light' href="#">Vancouver, Canada</a>
        <a className='underline block text-xl font-light' href="#">30 Chukarina St</a>
        <a className='underline block text-xl font-light' href="#">Lviv, Ukraine</a>
        </div>
      </div>
    </div>
  )
